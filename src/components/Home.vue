    ...
    <div class="wrapper">
        <div class="wrapper__left-wrapper">
            ...
            <div
                ...
                <p>
                    Thanks for checking out my work. Email me at johndatserakis at gmail dot com or use the form below if you'd like to chat. If you like this site you can <a href="https://github.com/johndatserakis/johndatserakis-dot-com">fork it</a> - it's open-source and written using Vue and Webpack.
                </p>
    ...
    methods: {
        ...
        async submitContactForm () {
            ...
            try {
                ...
                console.log(error)
                this.$toasted.error('There was an error sending your message. Please try again or email me directly. Thank you.')
            } finally {
                this.pending = false
            }
        }
